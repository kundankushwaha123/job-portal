...
@section('main-section')
                ...
                <div class="col-md-12">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="page-title">Total Jobs<span class="count-title">123</span></h4>
                            </div>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="offcanvas"
                                            data-bs-target="#offcanvas_add"><i
                                                class="ti ti-square-rounded-plus me-2"></i>Post New Jobs</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Search -->
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                            ...
                                            <div class="filter-set-view">
                                                ...
                                                <div class="filter-reset-btns">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <a href="deals.html" class="btn btn-primary">Filter</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="view-icons">
                                        <a href="deals.html" class="active"><i class="ti ti-list-tree"></i></a>
                                        <a href="deals-kanban.html"><i class="ti ti-grid-dots"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Filter -->
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
        ...
        <div class="offcanvas-body">
            <form action="https://crms.dreamstechnologies.com/html/template/deals.html">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-wrap access-item nav">
                            <div class="radio-btn" data-bs-toggle="tab" data-bs-target="#all">
                                <input type="radio" class="status-radio" id="all" name="status"
                                    checked="">
                                ...
                                <div class="access-wrapper">
                                    <div class="access-view">
                                        <div class="access-img">
                                            <img src="assets/img/profiles/avatar-21.jpg" alt="Image">Vaughan Lewis
                                        </div>
                                        <a href="#">Remove</a>
                                    </div>
                                    <div class="access-view">
                                        <div class="access-img">
                                            <img src="assets/img/profiles/avatar-01.jpg" alt="Image">Jessica Louise
                                        </div>
                                        <a href="#">Remove</a>
                                    </div>
                                </div>
