                ...
                <div class="col-md-12">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="page-title">Total Category<span
                                        class="count-title">{{ $jobcategories->count() }}</span></h4>
                            </div>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#create_jobcategory"><i
                                                class="ti ti-square-rounded-plus me-2"></i>Add New Category</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Search -->
                                        ...
                                        @foreach ($jobcategories as $jobrole)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="javascript:void(0);" data-bs-toggle="modal" class="text-danger"
    ...
    @foreach ($jobcategories as $jobrole)
        ...
        <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_edit{{ $jobrole->id }}">
            <div class="offcanvas-header border-bottom">
                <h5 class="fw-semibold">Edit Job Category</h5>
                <button type="button"
            ...
            <div class="offcanvas-body">
                <form action="{{ route('jobcategory.update', $jobrole->id) }}" method="post">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <select class="form-select" class="select" name="status">
                                    <option value="1" {{ $jobrole->status == 1 ? 'selected' : '' }}>Active</option>
                                    <option value="0"{{ $jobrole->status == 0 ? 'selected' : '' }}>Inactive</option>
                                </select>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Create Job Category</h5>
